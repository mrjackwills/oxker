...
+ `ctrl` key act as a modifier to scroll by a factor of ten, `config.toml` updated with `scroll_modifier`, will remove `scroll_down_many` & `scroll_down_up` in next release, [c5bbffdb5f9e800951e4060aa6aee8e00db589aa]
